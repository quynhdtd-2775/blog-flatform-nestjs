...
export class Migrations1786947573935 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "borrow_request_books" ("borrow_request_id" integer NOT NULL, "book_id" integer NOT NULL, "quantity" integer NOT NULL DEFAULT '1', CONSTRAINT "PK_9f4b54b2d496fbdc7bd2bafc6c2" PRIMARY KEY ("borrow_request_id", "book_id"))`,
    );
    await queryRunner.query(
