...
export class CreateLibrarySchema1786092725365 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "borrow_request_books" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL DEFAULT '1', "borrow_request_id" integer, "book_id" integer, CONSTRAINT "PK_3b7459fff43c0f0803fd9510d54" PRIMARY KEY ("id"))`);
